"""Platform for the Daikin BRP069A62."""
import base64
import datetime
import functools
import logging
...
from .const import DOMAIN, DAIKIN_DEVICES, CONF_TOKENSET, MP_GATEWAY
...
class DaikinApi:
    ...
    async def getCloudDeviceDetails(self):
        ...
        try:
            ...
            with open(jsonPath, 'w') as jsonFile:
                ...
                _LOGGER.debug("JSON data exported")
        except Exception as e:
            _LOGGER.error("JSON data export error '%s'", e)
    ...
    async def getCloudDevices(self):
        ...
        for dev_data in json_data or []:
            ...
            device_model = device.get_value(MP_GATEWAY, "modelInfo")
            _LOGGER.info("Daikin Residential Device model: '%s'", device_model)
